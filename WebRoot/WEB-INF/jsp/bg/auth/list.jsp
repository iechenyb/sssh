...
<html lang="zh-CN">
  <head>
	...
	<link href="${pageContext.request.contextPath }/themes/bg/assets/plugins/jquery-ui/css/jquery-ui-1.10.4.min.css"
		rel="stylesheet">
...
<!-- start: Header -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>权限信息列表</strong></h2>
								  ...
								  <tbody>
									<c:forEach var="entry" items="${pageView.records }">
										<tr>
											...
											<td>${entry.enabled }</td>
											<td>${entry.remark }</td>
											<td>${entry.modifyPeople }</td>
											<td>${entry.modifyTime }</td>
											<td>
												<a class="btn btn-success" href="table.html#"><i class="fa fa-search-plus "></i> 查看</a>
												<a class="btn btn-info" href="table.html#"><i class="fa fa-edit "></i> 编辑</a>
												<a class="btn btn-danger" href="table.html#"><i class="fa fa-trash-o "></i> 删除</a>
											</td>
										</tr>
									</c:forEach>				                                   
								  </tbody>
	...
	<script src="${pageContext.request.contextPath }/themes/bg/assets/plugins/datatables/js/jquery.dataTables.min.js"></script>
	<script src="${pageContext.request.contextPath }/themes/bg/assets/plugins/datatables/js/dataTables.bootstrap.min.js"></script>
	...
	<script src="${pageContext.request.contextPath }/themes/bg/assets/js/pages/table.js"></script>
