 ...
 * @project qjtid
 * @description 泛型工具类
 * @type com.lanlai.qjtid.common.utils.GenericsUtils     
 * @author blacksalon@163.com 
 * @date 2016年11月18日 上午9:00:52   
 * @version 1.0.0
 */
...
public class GenericsUtils {
	...
	/**  
     * 通过反射,获得指定类的父类的泛型参数的实际类型. 如UserInfoDaoImpl extends BaseDaoImpl<UserInfo>  
     *  
     ...
     * 		如UserInfoDaoImpl extends BaseDaoImpl<UserInfo>  
     *  
	...
	/**  
     * 通过反射,获得方法返回值泛型参数的实际类型. 如: public Map<String, UserInfo> getNames(){}
     *  
     ...
     * 		如: public Map<String, UserInfo> getNames(){}
     *  
     * @param Method method 方法
     * @return 泛型参数的实际类型, 如果没有实现ParameterizedType接口，
     * 			即不支持泛型，所以直接返回<code>Object.class</code>
     ...
     * 		如: public void add(Map<String, UserInfo> maps, List<String> names){}
     *  
     * @param Method method 方法
	...
	/**  
     * 通过反射,获得Field泛型参数的实际类型. 如: public Map<String, UserInfo> names;
     *  
     * @param Field field 字段
     * @param int index 泛型参数所在索引,从0开始.
     * @return 泛型参数的实际类型, 如果没有实现ParameterizedType接口，
